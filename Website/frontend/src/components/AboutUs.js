...
<div class="row">
    <div class="column">
        <div class="card">
            <img src="https://media.discordapp.net/attachments/893914165884882994/909167195249057873/IMG_9805.PNG?width=334&height=593" alt="Farzaan" style="width:100%" />
            <div class="container">
...
{/* <! -- Nick Goodchild -->
    <div class="column">
        <div class="card">
            <img src="https://cdn.discordapp.com/attachments/886044587712450630/909174573071761438/default-profile-icon-24.png" alt="Nick" style="width:100%" />
            <div class="container">
...
{/* <! -- Cameron Jackson -->
    <div class="column">
        <div class="card">
            <img src="https://media.discordapp.net/attachments/885725394110644224/909154845120946186/Screen_Shot_2021-11-13_at_10.56.41_AM.png" alt="Cameron" style="width:100%" />
            <div class="container">
